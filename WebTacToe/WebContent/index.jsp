...
<body onload="takeUsername()">
	...
	<div class="container">
		<div class="indexdiv">
			<div class="plwith">
				Play With!<img src="images/hand.png"
					style="width: 40px; height: 40px;"></img>
			</div>
			<a href="computer.jsp"><button
					class="btn btn-block btn-outline-primary">Computer</button></a><br>
			<a href="human.jsp"><button
					class="btn btn-block btn-outline-primary">Human</button></a><br>
		</div>
	</div>
